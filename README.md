...
--- Open three terminal ---
--
1) First terminal run: `npx convex dev` (for convex)
--
2) Second terminal run: `npm run dev` (for Next.js)
--
3) Third terminal run: `sudo docker ps` (I don't know if it is working on windows you should see something like: 0.0.0.0:2000->2000/tcp, [::]:2000->2000/tcp inspiring_meitner)
--
