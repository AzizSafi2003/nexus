...
function SnippetsPage() {
  ...
  const filteredSnippets = snippets.filter((snippet) => {
    /* we match key words types in search bar to any data available in snippets card: */
    const matchesSearch =
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="relative max-w-5xl mx-auto mb-12 space-y-6">
          ...
          <div className="relative group">
            ...
            <div className="absolute inset-0 bg-linear-to-r from-blue-500/30 to-purple-500/30 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500" />
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-[#1b1c22]/80 hover:bg-[#1b1c22] text-white
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2 px-4 py-2 bg-[#1b1c22] rounded-lg ring-1 ring-gray-800">
                ...
                className={`
                    ...
                    ${
                      selectedLanguage === lang
                        ...
                        : "text-gray-400 hover:text-gray-300 bg-[#1b1c22] hover:bg-[#262637] ring-1 ring-gray-800"
                    }
                  `}
              >
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              {/* View Toggle */}
              <div className="flex items-center gap-1 p-1 bg-[#1b1c22] rounded-lg ring-1 ring-gray-800">
                <button
