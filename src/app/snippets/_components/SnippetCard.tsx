  ...
  return (
    ...
    >
      <Link href={`/snippets/${snippet._id}`} className="h-full block">
        <div
          className="relative h-full bg-[#1b1c22]/70 backdrop-blur-sm rounded-xl 
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group/code">
                ...
                <pre className="relative bg-black/30 rounded-lg p-4 overflow-hidden text-sm text-gray-300 font-mono line-clamp-3 h-24.5">
                  {snippet.code}
                </pre>
              </div>
            </div>
