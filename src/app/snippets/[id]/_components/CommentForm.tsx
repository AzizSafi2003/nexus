...
function CommentForm({ isSubmitting, onSubmit }: CommentFormProps) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    if (e.key === "Tab") {
      /* Default behavior of Tab is going from one output to another or from the last input go to submit button. */
      e.preventDefault();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // If the comment is empty or just spaces:
    if (!comment.trim()) {
