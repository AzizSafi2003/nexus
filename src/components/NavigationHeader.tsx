        ...
        <div className="relative h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <Link
              ...
              border border-gray-800 hover:border-blue-500/50 transition-all duration-300 shadow-lg overflow-hidden mr-2 md:mr-0"
            >
              <div
                className="absolute inset-0 bg-linear-to-r from-blue-500/10 
              to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity"
              />
              <Code2 className="w-4 h-4 relative z-10 group-hover:rotate-3 transition-transform hidden md:block" />
              <span className="text-xs sm:text-sm font-medium relative z-10 group-hover:text-white transition-colors pr-4 sm:pr-0">
                Snippets
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-4">
            <SignedOut>
              <Link
                href="/pricing"
                className="group flex items-center gap-2 px-4 py-1.5 rounded-lg border border-amber-500/20
